...
function App() {
  ...
  <defs xmlns="http://www.w3.org/2000/svg">
    <clipPath id="a">
          ...
          </svg> Pic of the Day</h1>
                    <div>
            <PrevNextButton nav='prev' onClick={() => { handleClick(-1) }} />
            <DatePicker dateFormat='yyyy-MM-dd' selected={selectedDate} value = {date} onChange={newDate => setDate(dayjs(newDate).format('YYYY-MM-DD'))} customInput = {<CustomInput/>}></DatePicker>
